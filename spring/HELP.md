...
* [Thymeleaf](https://docs.spring.io/spring-boot/docs/3.0.0-M3/reference/htmlsingle/#boot-features-spring-mvc-template-engines)
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/3.0.0-M3/reference/htmlsingle/#production-ready)
